    ...
    <div className="card mb-6">
      ...
      <div className="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-4">
        <div className="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
          <img src="../../assets/img/avatars/1.png" alt="user image" className="d-block h-auto ms-0 ms-sm-5 rounded user-profile-img"/>
        </div>
          ...
          <div className="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
            <div className="user-profile-info">
              ...
              <ul className="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4">
                ...
                <li className="list-inline-item">
                  <i className='ri-calendar-line me-2 ri-24px'></i><span className="fw-medium"> Joined April 2021</span></li>
              </ul>
            </div>
            <a href="" className=" active btn btn-primary">
              <i className='ri-user-follow-line ri-16px me-1_5'></i>Connected
            </a>
          </div>
        </div>
      </div>
  ...
  <div className="col-md-12">
    <div className="nav-align-top">
      <ul className="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
        <li className="nav-item "><a className="nav-link active btn btn-primary" href=""><i className='ri-user-3-line me-1_5'></i>Profile</a></li>
        <li className="nav-item"><a className="nav-link" href="pages-profile-teams.html"><i className='ri-team-line me-1_5'></i>Teams</a></li>
        <li className="nav-item"><a className="nav-link" href="pages-profile-projects.html"><i className='ri-computer-line me-1_5'></i>Projects</a></li>
        <li className="nav-item"><a className="nav-link" href="pages-profile-connections.html"><i className='ri-link-m me-1_5'></i>Connections</a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <div className="col-xl-4 col-lg-5 col-md-5">
    ...
    <div className="card mb-6">
      <div className="card-body">
        ...
        <ul className="list-unstyled my-3 py-1">
          <li className="d-flex align-items-center mb-4"><i className="ri-user-3-line ri-24px"></i><span className="fw-medium mx-2">Full Name:</span> <span>John Doe</span></li>
          <li className="d-flex align-items-center mb-4"><i className="ri-check-line ri-24px"></i><span className="fw-medium mx-2">Status:</span> <span>Active</span></li>
          <li className="d-flex align-items-center mb-4"><i className="ri-star-smile-line ri-24px"></i><span className="fw-medium mx-2">Role:</span> <span>Developer</span></li>
          <li className="d-flex align-items-center mb-4"><i className="ri-flag-2-line ri-24px"></i><span className="fw-medium mx-2">Country:</span> <span>USA</span></li>
          <li className="d-flex align-items-center mb-2"><i className="ri-translate-2 ri-24px"></i><span className="fw-medium mx-2">Languages:</span> <span>English</span></li>
        </ul>
        <small className="card-text text-uppercase text-muted small">Contacts</small>
        <ul className="list-unstyled my-3 py-1">
          <li className="d-flex align-items-center mb-4"><i className="ri-phone-line ri-24px"></i><span className="fw-medium mx-2">Contact:</span> <span>(123) 456-7890</span></li>
          <li className="d-flex align-items-center mb-4"><i className="ri-wechat-line ri-24px"></i><span className="fw-medium mx-2">Skype:</span> <span>john.doe</span></li>
          <li className="d-flex align-items-center mb-2"><i className="ri-mail-open-line ri-24px"></i><span className="fw-medium mx-2">Email:</span> <span>john.doe@example.com</span></li>
        </ul>
        <small className="card-text text-uppercase text-muted small">Teams</small>
        <ul className="list-unstyled mb-0 mt-3 pt-1">
          <li className="d-flex align-items-center mb-4"><i className="ri-github-line ri-24px text-body me-2"></i>
            <div className="d-flex flex-wrap"><span className="fw-medium me-2">Backend Developer</span><span>(126 Members)</span></div>
          </li>
          <li className="d-flex align-items-center"><i className="ri-reactjs-line ri-24px text-body me-2"></i>
            <div className="d-flex flex-wrap"><span className="fw-medium me-2">React Developer</span><span>(98 Members)</span></div>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="card mb-6">
      <div className="card-body">
        ...
        <ul className="list-unstyled mb-0 mt-3 pt-1">
          <li className="d-flex align-items-center mb-4"><i className="ri-check-line ri-24px"></i><span className="fw-medium mx-2">Task Compiled:</span> <span>13.5k</span></li>
          <li className="d-flex align-items-center mb-4"><i className="ri-user-3-line ri-24px"></i><span className="fw-medium mx-2">Projects Compiled:</span> <span>146</span></li>
          <li className="d-flex align-items-center"><i className="ri-star-smile-line ri-24px"></i><span className="fw-medium mx-2">Connections:</span> <span>897</span></li>
        </ul>
      </div>
    </div>
  ...
  <div className="col-xl-8 col-lg-7 col-md-7">
    ...
    <div className="card card-action mb-6">
      <div className="card-header align-items-center">
        <h5 className="card-action-title mb-0"><i className='ri-bar-chart-2-line ri-24px text-body me-4'></i>Activity Timeline</h5>
      </div>
          ...
          <li className="timeline-item timeline-item-transparent">
            ...
            <div className="timeline-event">
              ...
              <div className="d-flex align-items-center mb-1">
                <div className="badge bg-lightest">
          ...
          <div className="card-header align-items-center">
            ...
            <div className="card-action-element">
              <div className="dropdown">
                <button type="button" className="btn dropdown-toggle hide-arrow p-0" data-bs-toggle="dropdown" aria-expanded="false"><i className="ri-more-2-line ri-22px text-muted"></i></button>
          ...
          <div className="card-body">
            <ul className="list-unstyled mb-0">
              <li className="mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <button className="btn btn-outline-primary btn-icon"><i className="ri-user-add-line ri-22px"></i></button>
                  </div>
                </div>
              </li>
              <li className="mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <button className="btn btn-primary btn-icon"><i className="ri-user-3-line ri-22px"></i></button>
                  </div>
                </div>
              </li>
              <li className="mb-4">
              ...
              <li className="text-center">
                <a href="javascript:;" className="btn btn-text-primary waves-effect">View all connections</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <ul className="list-unstyled mb-0">
              ...
              <li className="mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <a href="javascript:;"><span className="badge bg-label-primary rounded-pill">Support</span></a>
                  </div>
                </div>
              </li>
              <li className="mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <a href="javascript:;"><span className="badge bg-label-info rounded-pill">Designer</span></a>
                  </div>
                </div>
              </li>
              <li className="mb-4">
              ...
              <li className="mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <a href="javascript:;"><span className="badge bg-label-secondary rounded-pill">Marketing</span></a>
                  </div>
                </div>
              </li>
              <li className="text-center">
                <a href="javascript:;" className="btn btn-text-primary waves-effect">View all teams</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <a href="https://themeselection.com/item/materio-bootstrap-html-admin-template/" target="_blank" className="btn btn-danger btn-buy-now">Buy Now</a>
  </div>
</div>

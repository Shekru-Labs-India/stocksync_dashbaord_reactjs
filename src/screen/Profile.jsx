                    ...
                    <div className="flex-grow-1 mt-3 mt-lg-5">
                      <div className="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
                        <div className="user-profile-info">
                          ...
                          <ul className="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4">
                            <li className="list-inline-item">
                              <i className="ri-palette-line me-2 ri-24px"></i>
                              <span className="fw-medium">UX Designer</span>
                            </li>
                            <li className="list-inline-item">
                              <i className="ri-map-pin-line me-2 ri-24px"></i>
                        ...
                        <a href="" className=" active btn btn-primary">
                          <i className="ri-user-follow-line ri-16px me-1_5"></i>
                          Connected
                        </a>
                      </div>
                    </div>
                  ...
                  <ul className="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="pages-profile-teams.html">
                        <i className="ri-team-line me-1_5"></i>Teams
                      </a>
                    </li>
                    <li className="nav-item">
                      <a
                      ...
                      >
                        <i className="ri-computer-line me-1_5"></i>Projects
                      </a>
                    </li>
                    <li className="nav-item">
                      <a
                      ...
                      >
                        <i className="ri-link-m me-1_5"></i>Connections
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="card mb-6">
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled my-3 py-1">
                      ...
                      <li className="d-flex align-items-center mb-4">
                        <i className="ri-flag-2-line ri-24px"></i>
                        <span className="fw-medium mx-2">Country:</span>{" "}
                        <span>USA</span>
                      </li>
                      <li className="d-flex align-items-center mb-2">
                        <i className="ri-translate-2 ri-24px"></i>
                    ...
                    <ul className="list-unstyled my-3 py-1">
                      ...
                      <li className="d-flex align-items-center mb-4">
                        <i className="ri-wechat-line ri-24px"></i>
                ...
                <div className="card card-action mb-6">
                  <div className="card-header align-items-center">
                    <h5 className="card-action-title mb-0">
                      <i className="ri-bar-chart-2-line ri-24px text-body me-4"></i>
                      Activity Timeline
                    </h5>
                  </div>

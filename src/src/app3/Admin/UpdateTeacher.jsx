        ...
        <div className="card p-5">
          <div className="row align-items-center mb-5">
            ...
            <div className="col-6 text-start">
              <h5 className="mb-0">Update Teacher</h5>
            </div>
          </div>
          <div className="row">
                  ...
                  <div className="col-3">
                    <div className="form-floating form-floating-outline">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="brokerClientId"><span className="text-danger">*</span> Client ID</label>
                    </div>
                  </div>
                  ...
                  <div className="col-3">
                    <div className="form-floating form-floating-outline">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="brokerPassword"><span className="text-danger">*</span> Password</label>
                    </div>
                  </div>
                  <div className="col-3">
                    <div className="form-floating form-floating-outline">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="brokerQrTotpToken"><span className="text-danger">*</span>QR TOTP Token</label>
                    </div>
                  </div>
                  <div className="col-3  ">
                    <div className="form-floating form-floating-outline">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="brokerApiKey"><span className="text-danger">*</span> API Key</label>
                    </div>
                  </div>
                </div>

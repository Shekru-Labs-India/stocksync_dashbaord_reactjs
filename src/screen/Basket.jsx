...
const Basket = () => {
  ...
  //   const buyCount = rows.filter(row => row.transactionType === "1").length;
  //   const sellCount = rows.filter(row => row.transactionType === "2").length;
  ...
  //   // Here you can send the data to a server or perform further processing
  // };
  const handleCreateBasket = () => {

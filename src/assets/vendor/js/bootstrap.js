  ...
  return (function () {
    ...
    var It = {
          ...
          if (void 0 === a) {
            ...
            for (var p = 0, v = Object.entries(u); p < v.length; p++) {
              var m = Ye(v[p], 2),
                ...
                y = g.replace(wt, "");
              (c && !t.includes(y)) ||
                jt(e, l, s, _.callable, _.delegationSelector);
            }
          } else {
      ...
      trigger: function (e, t, n) {
        ...
        var c = Nt(new Event(t, { bubbles: o, cancelable: !0 }), n);
        return (
          s && c.preventDefault(),
          a && e.dispatchEvent(c),
      ...
      Wt = function (e) {
        ...
        try {
          for (r.s(); !(t = r.n()).done; ) {
            var o = t.value,
              a = o.replace(/^bs/, "");
            n[(a = a.charAt(0).toLowerCase() + a.slice(1, a.length))] = Mt(
              e.dataset[o]
            );
          }
        } catch (e) {
      ...
      Kt = {
        find: function (e) {
          ...
          return (t = []).concat.apply(
            t,
            Ge(Element.prototype.querySelectorAll.call(n, e))
          );
        },
        findOne: function (e) {
          var t =
      ...
      Qt = function (e) {
        ...
        It.on(document, n, '[data-bs-dismiss="'.concat(i, '"]'), function (n) {
          if (
            ...
            var r =
              Kt.getElementFromSelector(this) || this.closest(".".concat(i));
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  this._supportPointerEvents
                    ? (It.on(this._element, an, function (t) {
                        return e._start(t);
                      }),
                    ...
                    : (It.on(this._element, nn, function (t) {
                        return e._start(t);
                      }),
      ...
      Dn = (function (e) {
        function t(e, n) {
          ...
          return (
            ...
            (i.touchTimeout = null),
            (i._swipeHelper = null),
            (i._indicatorsElement = Kt.findOne(
              ".carousel-indicators",
              i._element
            )),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this._config.keyboard &&
                    It.on(this._element, yn, function (t) {
                      return e._keydown(t);
                    }),
                    "hover" === this._config.pause &&
                      (It.on(this._element, bn, function () {
                        return e.pause();
                      }),
    ...
    var In = ".".concat("bs.collapse"),
      ...
      Qn = { parent: "(null|element)", toggle: "boolean" },
      Un = (function (e) {
        function t(e, n) {
          var i;
          Ke(this, t),
          ...
          Ue(
            ...
            [
                  ...
                  if (!this._isTransitioning && !this._isShown()) {
                    ...
                    if (
                      ...
                      (n.length && n[0]._isTransitioning) ||
                        It.trigger(this._element, Nn).defaultPrevented)
                    ) {
                      var i,
                        r = $e(n);
                      try {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this._isShown() &&
                    !It.trigger(this._element, Fn).defaultPrevented
                  ) {
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    (e.toggle = Boolean(e.toggle)), (e.parent = at(e.parent)), e
                  );
                },
              },
              {
    ...
    It.on(document, Bn, Vn, function (e) {
      ...
      try {
        for (n.s(); !(t = n.n()).done; ) {
          var i = t.value;
          Un.getOrCreateInstance(i, { toggle: !1 }).toggle();
        }
      } catch (e) {
        n.e(e);
      } finally {
      ...
      _i = (function (e) {
        function t(e, n) {
          ...
          return (
            ...
            (i._menu =
              Kt.next(i._element, li)[0] ||
              Kt.prev(i._element, li)[0] ||
              Kt.findOne(li, i._parent)),
                    ...
                    if (!It.trigger(this._element, ti, e).defaultPrevented) {
                      if (
                        ...
                        var t,
                          n,
                          i = $e(
                            (t = []).concat.apply(t, Ge(document.body.children))
                          );
                        try {
                          for (i.s(); !(n = i.n()).done; ) {
                            var r = n.value;
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if ((r || i) && (!n || i)) {
                    e.preventDefault();
                    var o = this.matches(si)
                        ? this
                        : Kt.prev(this, si)[0] ||
                          Kt.next(this, si)[0] ||
                          Kt.findOne(si, e.delegateTarget.parentNode),
    ...
    var yi = "backdrop",
          ...
          Ue(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this._isActive &&
                    ((this._isActive = !1), It.off(document, Oi));
                },
              },
              {
                key: "_handleFocusin",
            ...
            },
            {
              ...
              value: function (e, t) {
                this._applyManipulationCallback(e, function (e) {
                  var n = Rt(e, t);
                  null !== n
                    ? (Bt(e, t), e.style.setProperty(t, n))
      ...
      Zi = (function (e) {
        function t(e, n) {
          ...
          return (
            Ke(this, t),
            ((i = Ne(this, t, [e, n]))._dialog = Kt.findOne(
              ".modal-dialog",
              i._element
            )),
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this._isShown ||
                    this._isTransitioning ||
                    It.trigger(this._element, Ri, { relatedTarget: e })
                      .defaultPrevented ||
                    ((this._isShown = !0),
                    (this._isTransitioning = !0),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this._isShown &&
                    !this._isTransitioning &&
                    (It.trigger(this._element, Hi).defaultPrevented ||
                      ((this._isShown = !1),
                      (this._isTransitioning = !0),
                    ...
                    this._queueCallback(
                      function () {
                        t._config.focus && t._focustrap.activate(),
                          ...
                          It.trigger(t._element, zi, { relatedTarget: e });
                      },
                      this._dialog,
                      this._isAnimated()
                    );
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this;
                  this._isShown ||
                    It.trigger(this._element, sr, { relatedTarget: e })
                      .defaultPrevented ||
                    ((this._isShown = !0),
                    this._backdrop.show(),
                    ...
                    this._queueCallback(
                      function () {
                        (t._config.scroll && !t._config.backdrop) ||
                          ...
                          It.trigger(t._element, cr, { relatedTarget: e });
                      },
                      this._element,
                      !0
                    ));
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  this._isShown &&
                    !It.trigger(this._element, lr).defaultPrevented &&
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
    ...
    It.on(document, hr, '[data-bs-toggle="offcanvas"]', function (e) {
      var t = this,
        n = Kt.getElementFromSelector(this);
      if (
        (["A", "AREA"].includes(this.tagName) && e.preventDefault(), !ct(this))
      ) {
    ...
    var _r = {
      ...
      wr = function (e, t) {
        ...
        return t.includes(n)
          ? !yr.has(n) || Boolean(br.test(e.nodeValue))
          : t
              .filter(function (e) {
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    ...
                    (this._config.content = qe(
                      qe({}, this._config.content),
                      e
                    )),
                    this
                  );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    c && (a = s.classList).add.apply(a, Ge(c.split(" "))), s
                  );
                },
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  i &&
                    ((t = this._resolvePossibleFunction(t))
                      ? ot(t)
                        ? this._putElementInTemplate(at(t), i)
                        : this._config.html
          ...
          Ue(
            ...
            [
                    ...
                    if (!t.defaultPrevented && n) {
                      ...
                      if (
                        ...
                        var o,
                          a,
                          s = $e(
                            (o = []).concat.apply(o, Ge(document.body.children))
                          );
                        try {
                          for (s.s(); !(a = s.n()).done; ) {
                            var c = a.value;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    if (
                      (this._getTipElement().classList.remove(xr),
                      "ontouchstart" in document.documentElement)
                    ) {
                      var t,
                        n,
                      ...
                      if ("click" === i)
                        ...
                        It.on(
                          ...
                          function (e) {
                            ...
                            (n._activeTrigger["focusin" === e.type ? Pr : jr] =
                              !0),
                              n._enter();
                          }
                        ),
              ...
              },
              {
                ...
                value: function (e) {
                  for (
                    var t = Wt(this._element), n = 0, i = Object.keys(t);
                    n < i.length;
                    n++
                  ) {
                    var r = i[n];
          ...
          Ue(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  return Ve(
                    Ve({}, ".popover-header", this._getTitle()),
                    ".popover-body",
                    this._getContent()
                  );
                },
          ...
          Ue(
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    (e.target = at(e.target) || document.body),
              ...
              },
              {
                ...
                value: function (e) {
                  this._activeTarget !== e &&
                    ...
                    It.trigger(this._element, Rr, { relatedTarget: e }));
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (!this._elemIsActive(e)) {
                    var t = this._getActiveElem(),
                      n = t ? It.trigger(t, Jr, { relatedTarget: e }) : null;
                    It.trigger(e, eo, { relatedTarget: t }).defaultPrevented ||
                      ...
                      function () {
                        "tab" === e.getAttribute("role")
                          ? (e.removeAttribute("tabindex"),
                            ...
                            It.trigger(e, to, { relatedTarget: t }))
                          : e.classList.add(po);
                      },
                      e,
                      ...
                      function () {
                        "tab" === e.getAttribute("role")
                          ? (e.setAttribute("aria-selected", !1),
                            ...
                            It.trigger(e, Zr, { relatedTarget: t }))
            ...
            [
              {
                ...
                value: function () {
                  var e = this;
                  It.trigger(this._element, So).defaultPrevented ||
                    (this._clearTimeout(),
                    this._config.animation &&
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  this.isShown() &&
                    !It.trigger(this._element, Co).defaultPrevented &&
